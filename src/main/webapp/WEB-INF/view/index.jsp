...
<body style="background:url(/pic/1.jpg);"> 
...
<div class="container-fluid" style="background:/*  url(/pic/.jpg) no-repeat; */ width:100%; height:100%;overflow: hidden;background-size:cover;" >
&nbsp;<br/>
&nbsp;
</div>
				...
				<div id="myCarousel" class="carousel slide" style="minheight:200px">
						...
						<div class="carousel-inner thumbnail" style="border-radius:12px;">
							<div class="item active">
								<img  class="img-rounded"  src="/resource/images/2.jpg" style=" border-radius:24px; align:center;width:800px; height:400px;" alt="First slide">
							</div>
							<div  class="item">
								<img  class="img-rounded" src="/resource/images/3.jpg"  style="border-radius:24px;width:800px; height:400px;" alt="Second slide">
							</div>
							<div class="item">
								<img  class="img-rounded" src="/resource/images/a.jpg" style="border-radius:24px; width:800px; height:400px;" alt="Third slide">
							</div>
						</div>
						<!-- 轮播（Carousel）导航 -->
					...
					<div >
						...
						<div class=row style="padding-bottom:1px">
							...
							<div class="col-md-2" style="text-align:right"><img height="80px" width="80px" src="/pic/${article.picture}" onerror="this.src='/resource/images/1.jpg'" class="img-rounded"></div>
							<div class="col-md-10">
